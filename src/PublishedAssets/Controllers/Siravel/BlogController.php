...
class BlogController extends Controller
{
    ...
    public function __construct(BlogRepository $blogRepo)
    {
        ...
        if (!in_array('blog', config('siravel.active-core-modules'))) {
    ...
    public function all()
    {
        ...
        return view('siravel-frontend::blog.all')
            ->with('tags', $tags)
            ->with('blogs', $blogs);
    }
    ...
    public function show($url)
    {
        ...
        return view('siravel-frontend::blog.'.$blog->template)->with('blog', $blog);
    }
}
