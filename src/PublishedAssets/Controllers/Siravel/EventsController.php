...
class EventsController extends Controller
{
    ...
    public function __construct(EventRepository $eventsRepo, EventService $eventService)
    {
        ...
        if (!in_array('events', config('siravel.active-core-modules'))) {
    ...
    public function calendar($date = null)
    {
        ...
        return view('siravel-frontend::events.calendar')
            ->with('events', $events)
    ...
    public function date($date)
    {
        ...
        return view('siravel-frontend::events.date')->with('events', $events);
    }
    ...
    public function all()
    {
        ...
        return view('siravel-frontend::events.all')->with('events', $events);
    }
    ...
    public function show($id)
    {
        ...
        return view('siravel-frontend::events.'.$event->template)->with('event', $event);
    }
}
